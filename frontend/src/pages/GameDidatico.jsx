...
export default function GameDidatico() {
  ...
  const imagemLetra = alfabeto[letraAlvo?.toUpperCase()];
        ...
        <div className="game-layout">
          <div className="container">
            ...
            <Card label="Sinal esperado" className="game-target-card" active={reconhecimentoBate} >
              {imagemLetra ? (
                <img src={imagemLetra} alt={`Sinal da letra ${letraAlvo}`} className="letter-image" />
              ) : (
